...
class fakenewsTrainerArguments(BasicArguments):
    def __init__(self, parser, root_path):
        ...
        self.parser.add_argument('--dataset_type', type=str, default='pkl', help='The format of the required dataset.')
        ...
        # identification mark
        self.parser.add_argument('--procedure', type = str, default = 'fakenews',
