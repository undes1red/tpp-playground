...
from src.fakenews.dataloader.utils import *
from src.fakenews.utils import getLogger, read_json
...
def dataloader_zoo(name):
    module = importlib.import_module('.' + name, package = 'src.fakenews.dataloader')
