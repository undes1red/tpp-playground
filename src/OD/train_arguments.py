...
from src.OD.utils import suffix
...
class TrainerArguments(BasicTrainerArguments):
    def __init__(self, parser, root_path):
        ...
        self.parser.add_argument('--procedure', type = str, default = 'OD',
                            help=argparse.SUPPRESS)
        self.parser.add_argument('--displayed_procedure_name', type = str, default = '(Omission) Outlier Detection',
                            help=argparse.SUPPRESS)
