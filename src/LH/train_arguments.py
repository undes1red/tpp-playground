...
from src.LH.utils import suffix
...
class TrainerArguments(BasicTrainerArguments):
    def __init__(self, parser, root_path):
        ...
        self.parser.add_argument('--procedure', type = str, default = 'LH',
                            help=argparse.SUPPRESS)
        self.parser.add_argument('--displayed_procedure_name', type = str, default = 'Long Horizon Prediction of Temporal Point Process',
                            help=argparse.SUPPRESS)
