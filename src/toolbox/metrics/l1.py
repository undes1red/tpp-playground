...
def L1_distance_across_events(input_data, time_next, has_flatten=False):  # noqa: N802
    """
    ...
    # [num_events, seq_len, resolution]
    else:
        input_data = rearrange(input_data, "s r ne -> ne s r")  # [num_events, seq_len, resolution]
    intensity_1 = rearrange(input_data, "ne s r -> ne () s r")  # [num_events, 1, seq_len, resolution]
    intensity_2 = rearrange(input_data, "ne s r -> () ne s r")  # [1, num_events, seq_len, resolution]
