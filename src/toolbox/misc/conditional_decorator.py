...
def conditional_decorator(*args, **kwargs):
    if len(args) + len(kwargs) == 2:
        ...
        raise Exception(f'The input of conditional_decorator is either "decorator + condition" or "decorator + condition + target function". While we got {len(args) + len(kwargs)} arguments.')
