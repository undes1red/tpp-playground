...
from src.tpp.tpp_models.sahp.plot import *
from src.tpp.tpp_models.sahp.submodel import SAHP
from src.tpp.tpp_models.sahp.sample import sample_time
from src.tpp.tpp_models.utils import get_f1_and_top_k_acc_in_mae_e, decide_resolution_inf_and_resolution_between_events, pick_log_probability


class SAHPWrapper(BasicModel):
    '''
    Self-attentive Hawkes Process (SAHP), proposed by Zhang et al. at ICML 2020.
    '''
    ...
    def figure_debug(self, input_data, opt):
        ...
        f1_2, top_k, probability_sum, _, tau_pred_all_event, maes_avg, maes \
            = self.mean_absolute_error_e(time_history, time_next, events_history, events_next, mask_history, 
                                         mask_next, mean, std, return_mean = False, opt = opt)
