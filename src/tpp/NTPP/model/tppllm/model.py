...
from src.tpp.tpp_models.tppllm.sample import sample_time
from src.tpp.tpp_models.basic_tpp_model import memory_ceiling, BasicModel
from src.tpp.tpp_models.tppllm.plot import *
from src.tpp.tpp_models.tppllm.submodel import TPPLLM
...
class TPPLLMWrapper(BasicModel):
    ...
    def evaluate_procedure(self, time, events, mask, mean, std):
        ...
        '''
        mae, f1_pred = self.mean_absolute_error_and_f1(events_history, time_history, 
        ...
        return log_likeli_loss_time_next_without_dummy, loss_survival, marker_loss_time_next_without_dummy, \
               mae, f1_pred, the_number_of_events
    ...
    def figure_debug(self, input_data, opt):
        ...
        mae, f1_1 = self.mean_absolute_error_and_f1(events_history, time_history, events_next, time_next, mask_history, mask_next, mean, std)
                                                                               # [batch_size, seq_len]
