...
from src.tpp.tpp_models.llmtpp_icl.description_gen_prompt import prompt_dict as desc_prompt_dict
from src.tpp.tpp_models.llmtpp_icl.event_predict_prompt import prompt_dict as pred_prompt_dict
