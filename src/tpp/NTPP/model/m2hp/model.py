...
from src.tpp.tpp_models.m2hp.plot import *
from src.tpp.tpp_models.m2hp.submodel import M2HP
from src.tpp.tpp_models.utils import *
from src.tpp.tpp_models.m2hp.utils import *
...
class M2HPWrapper(BasicModel):
    def __init__(self, opt, device, mode = 'pure_mamba', d_input = 64, d_mamba = 64, n_layers = 3,
        ...
        self.model = M2HP(num_events = self.num_events, d_input = d_input, d_mamba = d_mamba, \
