...
class NES(nn.Module):
    ...
    def forward(self, probability_model, model_args, mask_history, number_of_events, \
        ...
        input_probability = probability_model(*model_args)                     # [batch_size, length_of_h]
