...
class Transformer(nn.Module):
    ...
    def __init__(self, device, d_input, d_rnn, d_hidden, n_layers_decoder, n_head, d_qk, d_v, dropout):
        super(Transformer, self).__init__()
        self.device = device
        self.transformer_module = TransformerModule(
            d_input = d_input, d_hidden = d_hidden, n_layers_decoder = n_layers_decoder, \
    ...
    def forward(self, input_x, mask):
        ...
        enc_output = self.transformer_module(input_x, mask)                    # [batch_size, seq_len, d_input]
...
class TransformerModule(nn.Module):
    ...
    def __init__(self, d_input, d_hidden, n_layers_decoder, n_head, d_qk, d_v, dropout, device):
    ...
    def forward(self, input_x, mask):
        ...
        output = self.decoder(input_x, non_pad_mask = mask, self_attn_mask = None)
