...
from src.MDI.utils import suffix
...
class EvaluatorArguments(BasicEvaluatorArguments):
    def __init__(self, parser, root_path):
        ...
        # identification mark
        self.parser.add_argument('--procedure', type = str, default = 'MDI',
                            help=argparse.SUPPRESS)
        self.parser.add_argument('--displayed_procedure_name', type = str, default = 'Missing Data Imputation',
                            help=argparse.SUPPRESS)
