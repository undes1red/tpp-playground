...
from src.tpp.tpp_models.tppllm.transformers import TemporalLLM
...
class TPPLLM(nn.Module):
    ...
    def get_conditional_intensity_and_integral(self, history_embedding, time_next):
        ...
        expanded_scaled_time = self.alpha * expanded_time.unsqueeze(dim = -1)  # [..., batch_size, seq_len, integration_sample_rate, num_events]
    ...
    def get_conditional_intensity_and_integral_time_next_2d(self, history_embedding, time_next, integration_sample_rate, time_next_start):
        ...
        scaled_time = expanded_time.unsqueeze(dim = -1)                        # [..., batch_size, seq_len, integration_sample_rate, 1]
