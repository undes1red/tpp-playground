...
from src.tpp.tpp_models.resources.syn_tpp_utils import expand_true_intensity, expand_true_probability
...
def generate_intensity_figure(data, opt):
    ...
    for idx, (
        ...
        fig = draw_intensity_integral_and_probability(
            df_intensity_plot, df_event, annotation, "Intensity", color_palette, num_marks
        )
...
def generate_integral_figure(data, opt):
    ...
    for idx, (
        ...
        fig = draw_intensity_integral_and_probability(
            df_integral_plot, df_event, None, "Integral", color_palette, num_marks
        )
...
def generate_probability_figure(data, opt):
    ...
    for idx, (
        ...
        fig = draw_intensity_integral_and_probability(
            df_probability_plot, df_event, annotation, "Probability", color_palette, num_marks
        )
...
def generate_debug_figure(data, opt):
    ...
    for idx, (
        ...
        event_list = [f"Mark {i}" for i in range(num_marks)]
        ...
        fig1 = draw_intensity_integral_per_mark(df_intensity, df_event, "Intensity", color_palette, num_marks)
        ...
        fig2 = draw_intensity_integral_per_mark(df_integral, df_event, "Integral", color_palette, num_marks)
    ...
    # Part 7: the value of \\sum_{m \\in M}{p^*(m)} given different history.
    ...
    # Part 8: The Logarithm of time prediction against all marks
