...
stackoverflow_training_hyperparameter_list = [
    ...
    "--dataloader_config", "stackoverflow/fullynn_dl.yml",
    ...
    "--model_name", "fullynn", \
    "--model_config", "stackoverflow/fullynn.yml",
    "--lr", "0.002", \
    "--save_mode", "best", \
    "--lr_sched", \
    "--op_name", "AdamW", \
...
retweet_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "retweet/fullynn_dl.yml",
    ...
    "--model_name", "fullynn", \
    "--model_config", "retweet/fullynn.yml",
    "--lr", "0.002", \
    "--save_mode", "best", \
    "--lr_sched", \
    "--op_name", "AdamW", \
...
mooc_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "mooc/fullynn_dl.yml",
    "--dataset_name", "mooc", \
    "--n_training_steps", "400000", \
    "--n_evaluation_steps", "4000", \
    "--n_report_steps", "4000", \
...
bookorder_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "bookorder/fullynn_dl.yml",
    ...
    "--n_warmup_steps", "4000", \
    "--model_name", "fullynn", \
    "--model_config", "bookorder/fullynn.yml",
    "--lr", "0.002", \
    "--save_mode", "best", \
    "--lr_sched", \
    "--op_name", "AdamW", \
...
retweet_plot_hyperparameter_list = [
    ...
    # "--evaluation", \
    "--test", \
    "--used_dataloader_config", "fullynn_dl.yml", \
