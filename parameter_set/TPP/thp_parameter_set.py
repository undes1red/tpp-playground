...
stackoverflow_training_hyperparameter_list = [
    ...
    "--dataloader_config", "stackoverflow/thp_dl.yml",
    ...
    "--model_name", "thp", \
    "--model_config", "stackoverflow/thp.yml",
    "--lr", "0.002", \
    "--save_mode", "best", \
    "--lr_sched", \
    "--op_name", "AdamW", \
...
retweet_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "retweet/thp_dl.yml",
...
mooc_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "mooc/thp_dl.yml",
    "--dataset_name", "mooc", \
    "--n_training_steps", "400000", \
    "--n_evaluation_steps", "4000", \
    "--n_report_steps", "4000", \
...
bookorder_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "bookorder/thp_dl.yml",
    ...
    "--n_warmup_steps", "4000", \
    "--model_name", "thp", \
    "--model_config", "bookorder/thp.yml",
    "--lr", "0.002", \
    "--save_mode", "best", \
    "--lr_sched", \
    "--op_name", "AdamW", \
