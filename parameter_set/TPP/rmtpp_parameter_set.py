...
stackoverflow_training_hyperparameter_list = [
    ...
    "--dataloader_config", "stackoverflow/rmtpp_dl.yml",
    ...
    "--n_warmup_steps", "2000", \
    "--model_name", "rmtpp", \
    "--model_config", "stackoverflow/rmtpp.yml",
    "--lr", "0.001", \
    "--save_mode", "best", \
    "--lr_sched", \
    "--op_name", "AdamW", \
...
retweet_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "retweet/rmtpp_dl.yml",
    ...
    "--model_name", "rmtpp", \
    "--model_config", "retweet/rmtpp.yml",
    "--lr", "0.001", \
    "--save_mode", "best", \
    "--lr_sched", \
    "--op_name", "AdamW", \
...
mooc_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "mooc/rmtpp_dl.yml",
    "--dataset_name", "mooc", \
...
bookorder_training_hyperparameter_list = [
    ...
    "--no_seed", \
    "--dataloader_name", "generic", \
    "--dataloader_config", "bookorder/rmtpp_dl.yml",
    ...
    "--n_warmup_steps", "1000", \
    "--model_name", "rmtpp", \
    "--model_config", "bookorder/rmtpp.yml",
    "--lr", "0.001", \
    "--save_mode", "best", \
    "--lr_sched", \
    "--op_name", "AdamW", \
...
retweet_plot_hyperparameter_list = [
    ...
    # "--evaluation", \
    "--test", \
    "--used_dataloader_config", "rmtpp_dl.yml", \
